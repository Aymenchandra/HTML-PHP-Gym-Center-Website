<?php 
   ...
   if(isset($_SESSION["user"]))
   {
      ...
      if($_SERVER["REQUEST_METHOD"]=="POST")
      {
        ...
        $age = $_POST["age"]; 
          if(isset($_POST["modifier"]))
          {
            ...
            if(strcmp($date,$d)!=0)
            {
                mysqli_query($conn,"UPDATE registers SET datenaissance='$date' where email='$e'");
                $affiche="Modifié avec succes";
                $d = $date;
            }
            if(strcmp($age,$a)!=0)
    ...
    else die ("Tu doit connecter dans notre premier page");   
      ...
      <div class="container"> 
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a class="page-scroll" href="#button-box"><?php if (isset($e))echo $e; ?></a></li>
          </ul>
        </div>
      </div>
    </nav>
        ...
        <div class="hero">
          <div id="form-box">
              ...
              <form method="POST" action="deconnexion.php">
                  <div id="btn"></div>
                  <button type="button" id="toggle-btn" onclick="login()">Modifer</button>
                  <button type="submit" id="toggle-btn" name="logout">Déconnecter</button>
                  </div>
              </form>
              <form class="input-group" id="modifier" name="f1" method="POST" action="<?php $_SERVER["PHP_SELF"];?>">
              <p class="modif" ><?php if(isset($affiche)) echo $affiche;  ?></p>
                  <input type="text" id="input-field" name="nom" placeholder="Nom d'utilisateur..." value="<?php if(isset($n)) echo $n ?>">
                  <input type="text" id="input-field" name="prenom" placeholder="Prenom d'utilisateur..." value="<?php if(isset($p)) echo $p ?>">
                  ...
                  <input type="text" id="input-field" name="date" placeholder="Date De Naissance..."onblur="calc_age()" value="<?php if(isset($d)) echo $d ?>">
                  <input type="text" id="input-field" name="age" placeholder="Age..." value="<?php if(isset($a)) echo $a ?>">   
                  <button type="submit" id="sumbit-btn" onclick="verif1()" name="modifier">modifier</button>
...
<script type="text/javascript" src="../js/controle1.js"></script> 
